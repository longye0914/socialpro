...
class CardVisitUser extends StatelessWidget {
  final List<Visitlist> articleData;
  String tk, headimg;
  int gender;
  MyInfoData myInfo;
  CardVisitUser({Key key, this.articleData, this.tk, this.gender, this.headimg, this.myInfo}) : super(key: key);
  @override
