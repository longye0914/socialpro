...
import 'package:tnsocialpro/widget/app_size.dart';
...
class ThemeTextStyle{
  static final monitorTitleStype = TextStyle(fontSize: 14,color: rgba(255, 0, 0, 1), fontWeight: FontWeight.bold);
  static final notifyTitleStype = TextStyle(fontSize: 14,color: rgba(34, 34, 34, 1), fontWeight: FontWeight.bold);
  static final notifyTimeStype = TextStyle(fontSize: 14,color: rgba(183, 183, 184, 1));
