...
FanslistParent _$FanslistParentFromJson(Map<String, dynamic> json) {
  return FanslistParent(
    code: json['code'] as int,
    msg: json['msg'] as String,
    data: (json['data'] as List)
        ?.map((e) =>
    e == null ? null : Fanslist.fromJson(e as Map<String, dynamic>))
        ?.toList(),
    success: json['success'] as bool,
  );
}

Map<String, dynamic> _$FanslistParentToJson(FanslistParent instance) =>
    <String, dynamic>{
      'code': instance.code,
      'msg': instance.msg,
      'data': instance.data,
...
Fanslist _$FanslistFromJson(Map<String, dynamic> json) {
  return Fanslist(
    id: json['id'] as int,
...
Map<String, dynamic> _$FanslistToJson(Fanslist instance) =>
    <String, dynamic>{
      'id': instance.id,
