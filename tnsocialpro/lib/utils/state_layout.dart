...
import 'package:tnsocialpro/utils/resources.dart';
import 'package:tnsocialpro/utils/theme_utils.dart';
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Text(
          ...
          style: Theme.of(context).textTheme.subtitle1.copyWith(fontSize: Dimens.font_sp14),
        ),
        Gaps.vGap50,
      ],
    );
