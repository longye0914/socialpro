...
class _ReceiveOrderPageState extends State<ReceiveOrderPage> with WidgetsBindingObserver {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              height: 20,
              width: double.infinity,
              child: Text('完成以下任务即可开始聊天赚钱', style: TextStyle(color: rgba(255, 255, 255, 1), fontWeight: FontWeight.w400, fontSize: 14),),
            ),
            Container(
              ...
              height: 20,
              width: double.infinity,
              child: Text('Step 1', style: TextStyle(color: rgba(255, 255, 255, 1), fontWeight: FontWeight.w500, fontSize: 16),),
            ),
            Container(
              height: 60,
              ...
              child: Row(
                ...
                children: [
                  Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: Image.asset(
                            (null == widget.myInfoData || null == widget.myInfoData.infoflag || 0 == widget.myInfoData.infoflag) ? 'assets/images/icon_ordernormal.png' : 'assets/images/icon_orderchoose.png',
                            height: 20,
                            width: 20,
                            fit: BoxFit.fill,
                          ),
                  ...
                  (null == widget.myInfoData || null == widget.myInfoData.infoflag || 0 == widget.myInfoData.infoflag)  ? GestureDetector(
                    onTap: () {
                      // 去完成资料
                    ...
                    child: Container(
                      ...
                      decoration: new BoxDecoration(
                        image: new DecorationImage(
                          image: new AssetImage('assets/images/icon_orderbg.png'),
            ...
            Container(
              ...
              height: 20,
              width: double.infinity,
              child: Text('Step 2', style: TextStyle(color: rgba(255, 255, 255, 1), fontWeight: FontWeight.w500, fontSize: 16),),
            ),
            Container(
              height: 60,
              margin: EdgeInsets.only(left: 25, right: 25, top: 5),
              ...
              child: Row(
                ...
                children: [
                  Row(
                      ...
                      children: [
                        Container(
                          ...
                          margin: EdgeInsets.only(right: 6, left: 12),
                          child: Image.asset(
                            (null == widget.myInfoData || null == widget.myInfoData.voiceflag || 0 == widget.myInfoData.voiceflag) ? 'assets/images/icon_ordernormal.png' : 'assets/images/icon_orderchoose.png',
                            height: 20,
                            width: 20,
                            fit: BoxFit.fill,
                          ),
                  ...
                  (null == widget.myInfoData || null == widget.myInfoData.voiceflag || 0 == widget.myInfoData.voiceflag) ? GestureDetector(
                    onTap: () {
                      // 去完成资料
                      if (null == widget.myInfoData) {
                        Navigator.push(
            ...
            Container(
              ...
              height: 20,
              width: double.infinity,
              child: Text('Step 3', style: TextStyle(color: rgba(255, 255, 255, 1), fontWeight: FontWeight.w500, fontSize: 16),),
            ),
            Container(
              height: 60,
              margin: EdgeInsets.only(left: 25, right: 25, top: 5),
              ...
              child: Row(
                ...
                children: [
                  Row(
                      ...
                      children: [
                        Container(
                          ...
                          margin: EdgeInsets.only(right: 6, left: 12),
                          child: Image.asset(
                            (null == widget.myInfoData || null == widget.myInfoData.picflag || 0 == widget.myInfoData.picflag) ? 'assets/images/icon_ordernormal.png' : 'assets/images/icon_orderchoose.png',
                            height: 20,
                            width: 20,
                            fit: BoxFit.fill,
                          ),
                  ...
                  (null == widget.myInfoData || null == widget.myInfoData.picflag || 0 == widget.myInfoData.picflag) ? GestureDetector(
                    onTap: () {
                      // 去完成资料
                      if (null == widget.myInfoData) {
                        Navigator.push(
            ...
            Container(
              ...
              height: 20,
              width: double.infinity,
              child: Text('Step 4', style: TextStyle(color: rgba(255, 255, 255, 1), fontWeight: FontWeight.w500, fontSize: 16),),
            ),
            Container(
              height: 60,
              margin: EdgeInsets.only(left: 25, right: 25, top: 5),
              ...
              child: Row(
                ...
                children: [
                  Row(
                      ...
                      children: [
                        Container(
                          ...
                          margin: EdgeInsets.only(right: 6, left: 12),
                          child: Image.asset(
                            (null == widget.myInfoData || null == widget.myInfoData.taskflag || 0 == widget.myInfoData.taskflag) ? 'assets/images/icon_ordernormal.png' : 'assets/images/icon_orderchoose.png',
                            height: 20,
                            width: 20,
                            fit: BoxFit.fill,
                          ),
                  ...
                  (null == widget.myInfoData || null == widget.myInfoData.taskflag || 0 == widget.myInfoData.taskflag) ? GestureDetector(
                    onTap: () {
                      // 去完成资料
                      if (null == widget.myInfoData) {
                        Navigator.push(
            ...
            GestureDetector(
              onTap: () {
                ...
                if (null == widget.myInfoData.voiceflag || 0 == widget.myInfoData.voiceflag) {
                  Fluttertoast.showToast(msg: '录制一段我的声音');
                  return;
                }
                if (null == widget.myInfoData.picflag || 0 == widget.myInfoData.picflag) {
              ...
              child: Container(
                ...
                decoration: new BoxDecoration(
                  image: new DecorationImage(
                    image: new AssetImage(((null == widget.myInfoData || null == widget.myInfoData.infoflag || 0 == widget.myInfoData.infoflag) || (null == widget.myInfoData.voiceflag || 0 == widget.myInfoData.voiceflag) || (null == widget.myInfoData.picflag || 0 == widget.myInfoData.picflag) || (null == widget.myInfoData.taskflag || 0 == widget.myInfoData.taskflag)) ? 'assets/images/icon_orderunfinish.png' : 'assets/images/icon_orderfinished.png'),
                    //这里是从assets静态文件中获取的，也可以new NetworkImage(）从网络上获取
                    // centerSlice: new Rect.fromLTRB(270.0, 180.0, 1360.0, 730.0),
                  ),
                ),
                ...
                child: Text(
                  '完成任务',
                  style: TextStyle(
                      color: ((null == widget.myInfoData || null == widget.myInfoData.infoflag || 0 == widget.myInfoData.infoflag) || (null == widget.myInfoData.voiceflag || 0 == widget.myInfoData.voiceflag) || (null == widget.myInfoData.picflag || 0 == widget.myInfoData.picflag) || (null == widget.myInfoData.taskflag || 0 == widget.myInfoData.taskflag)) ? rgba(150, 148, 166, 1) : rgba(69, 65, 103, 1),
                      fontSize: 15,
                      fontWeight: FontWeight.w500),
                ),
              ),
