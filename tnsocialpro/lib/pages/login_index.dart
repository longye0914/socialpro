...
class _LoginIndexState extends State<LoginIndex>
                              ...
                              children: [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        alignment: Alignment.center,
                                        margin: EdgeInsets.only(left: 0, right: 9, top: 19),
                                        // alignment: Alignment.centerLeft,
                                ...
                                isShowButton2
                                  ...
                                  child: Container(
                                    ...
                                    decoration: new BoxDecoration(
                                      image: new DecorationImage(
                                        image: new AssetImage('assets/images/icon_loginchoosed.png'),
                                        //这里是从assets静态文件中获取的，也可以new NetworkImage(）从网络上获取
                                        // centerSlice: new Rect.fromLTRB(270.0, 180.0, 1360.0, 730.0),
                                      ),
                                    ),
                                  ...
                                  alignment: Alignment.center,
                                  decoration: new BoxDecoration(
                                    borderRadius: new BorderRadius.all(new Radius.circular(27.5)),
                                    image: new DecorationImage(
                                      image: new AssetImage('assets/images/icon_loginunchoose.png'),
                                      //这里是从assets静态文件中获取的，也可以new NetworkImage(）从网络上获取
                                      centerSlice: new Rect.fromLTRB(270.0, 180.0, 1360.0, 730.0),
                                    ),
                                  ),
    ...
    try {
      ...
      if (20000 == code) {
        try {
          ...
          prefs.setString('phone', _userEtControllerPhone.text.toString().trim());
          if (null == gender) {
            Navigator.push(
                context,
                new MaterialPageRoute(
                    builder: (context) => new GenderinfoPage(tk)));
          } else {
            Navigator.push(
                context,
                new MaterialPageRoute(
                    builder: (context) => new TabNavigate(tk, _userEtControllerPhone.text.toString().trim(), gender)));
          }
          await G.toast('登录成功');
        } on EMError catch (e) {
          print("eerrr");
  ...
  getMsgAuth() async {
    ...
    // }
    try {
      var res = await G.req.user.getCodeReq(phone: _userEtControllerPhone.text.toString().trim());
      print(res);
  ...
  validateCodeReq(String access_token, String codeV) async {
    try {
      var res = await G.req.user.validateCodeReq(phone: codephone['value'], smsCode: codeV);
