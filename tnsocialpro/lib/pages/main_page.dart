...
class MainPage extends StatefulWidget {
  ...
  MainPage(this.tk, this.gender, this.headimg, this.mainUser, this.bannerListDatas);
  @override
          ...
          children: <Widget>[
                          ...
                          onTap: () {
                            ...
                            Navigator.push(
                                ...
                                new MaterialPageRoute(
                                    builder: (context) => new GrampphonePage(widget.tk, widget.headimg, widget.gender)));
                          },
                          child: Container(
                              height: 34,
                              width: 116,
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    margin: EdgeInsets.only(right: 5, left: 13),
                                    width: 23,
                                    height: 20,
                                    alignment: Alignment.centerLeft,
                                    child: Image.asset(
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                        '邂逅留声机',
                                        style: TextStyle(
                                            fontSize: 11, color: rgba(69, 65, 103, 1), fontWeight: FontWeight.w400)),
                                  ),
                                ],
                              )
                          ),
            ...
            Expanded(
              ...
              child: EasyRefresh(
                    ...
                    child: ListView(
                      children: <Widget>[
                        (widget.bannerListDatas.isEmpty) ? Container() : Container(
                          // color: rgba(246, 243, 249, 1),
                        ...
                        (widget.mainUser.isEmpty) ? Container() : CardMainUser(articleData: widget.mainUser, tk: widget.tk, gender: widget.gender, headimg: widget.headimg)
                      ],
                    ),
                  onRefresh: () async {
                    getAllUserData();
    ...
    try {
      ...
      if (res.data != null) {
        setState(() {
          ...
          widget.bannerListDatas.addAll(BannerlistParent.fromJson(res.data).data);
