...
import 'package:tnsocialpro/event/modifypath_event.dart';
...
class ModifyPathPage extends StatefulWidget {
  ...
  ModifyPathPage(
      ...
      : super(key: key);
  _ModifyPathPageState createState() => _ModifyPathPageState();
}

class _ModifyPathPageState extends State<ModifyPathPage> {
  ...
  updateUserInfo(String value) async {
    ...
    try {
      ...
      if (20000 == code) {
        // 修改
        modifyPathBus.fire(new ModifyPathEvent(value));
        // setState(() {});
        G.toast('修改成功');
