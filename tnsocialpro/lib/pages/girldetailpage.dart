...
class _GirlDetailPageState extends State<GirlDetailPage> {
  ...
  bool isActive = false;
  final List<Image> _assetList = [
    Image.asset('assets/images/left_voice_1.png'),
    Image.asset('assets/images/left_voice_2.png'),
    Image.asset('assets/images/left_voice_3.png')
  ];
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: NetworkImage((null == myInfoData ||
                                    null == myInfoData.userpic ||
                                    myInfoData.userpic.isEmpty)
                                ? ''
                                : myInfoData.userpic),
                            fit: BoxFit.cover
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    child: Image.asset(
                                      (0 == likestate)
                                          ? 'assets/images/icon_likenormal.png'
                                          : 'assets/images/icon_likechoose.png',
                                      width: 46,
                                      height: 46,
                                      fit: BoxFit.fill,
                                    ),
                                    ...
                                    leftChild: Row(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Text(
                                              (null == myInfoData ||
                                                      myInfoData.path == null ||
                                                      myInfoData.path.isEmpty)
                                                  ? '未知'
                                                  : myInfoData.path,
                                              style: TextStyle(
                                                  fontSize: 12,
                                              ...
                                              decoration: new BoxDecoration(
                                                image: new DecorationImage(
                                                  image: new AssetImage(
                                                      'assets/images/icon_phonevoicebg.png'),
                                                  //这里是从assets静态文件中获取的，也可以new NetworkImage(）从网络上获取
                                                  // centerSlice: new Rect.fromLTRB(270.0, 180.0, 1360.0, 730.0),
                                                ),
                                              ),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          (null == myInfoData ||
                                  null == myInfoData.voiceset ||
                                  myInfoData.voiceset.isEmpty)
                              ? Container()
                              : Container(
                                  height: 36,
                                  width: 200,
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      (null != myInfoData &&
                                              myInfoData.voiceset.isNotEmpty)
                                          ? Container(
                                              margin: EdgeInsets.only(left: 23),
                                              child: Text(
                                                  myInfoData.voiceset
                          ...
                          (null == myInfoData ||
                                  null == myInfoData.videoset ||
                                  myInfoData.videoset.isEmpty)
                              ? Container()
                              : Container(
                                  height: 36,
                                  width: 200,
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      (null != myInfoData &&
                                              myInfoData.videoset.isNotEmpty)
                                          ? Container(
                                              margin: EdgeInsets.only(left: 23),
                                              child: Text(
                                                  myInfoData.videoset
                          ...
                          GestureDetector(
                            ...
                            child: (null == pictureList || pictureList.isEmpty)
                                ? Container()
                                : (1 == pictureList.length)
                                    ? Container(
                                        alignment: Alignment.center,
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text(
                                      (null == myInfoData ||
                                              null == myInfoData.signinfo ||
                                              myInfoData.signinfo.isEmpty)
                                          ? ''
                                          : myInfoData.signinfo,
                                      style: TextStyle(
                                          fontSize: 14,
                          ...
                          Container(
                            margin:
                                EdgeInsets.only(left: 38, top: 19, bottom: 9),
                            child: Text(
                                (null == myInfoData ||
                                        null == myInfoData.myselfintro ||
                                        myInfoData.myselfintro.isEmpty)
                                    ? ''
                                    : myInfoData.myselfintro,
                                style: TextStyle(
                                    fontSize: 14,
                                    color: rgba(69, 65, 103, 1),
                                    fontWeight: FontWeight.w400)),
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          // 1V1语音聊天
                          if (null != myInfoData) {
                            onAudio(context, myInfoData.id, myInfoData.username,
                                myInfoData.userpic);
                          }
                        },
                        child: Container(
                      ...
                      GestureDetector(
                        onTap: () {
                          // 1V1视频聊天
                          if (null != myInfoData) {
                            onVideo(context, myInfoData.id, myInfoData.username,
                                myInfoData.userpic);
                          }
                        },
                        child: Container(
  ...
  getUserDetail() async {
    try {
      var res = await G.req.shop.getUserDetailReq(tk: widget.tk, id: widget.id);
      if (res.data != null) {
  ...
  getFollowUserState() async {
    try {
      var res = await G.req.shop
          .getFollowUserStateReq(tk: widget.tk, follow_id: widget.id);
      if (res.data != null) {
        int code = res.data['code'];
  ...
  followUserReq() async {
    try {
      var res =
          await G.req.shop.followUserReq(tk: widget.tk, follow_id: widget.id);
      if (res.data != null) {
        int code = res.data['code'];
        if (20000 == code) {
          getFollowUserState();
  ...
  cancelfollowUserReq() async {
    try {
      var res = await G.req.shop
          .cancelfollowUserReq(tk: widget.tk, follow_id: widget.id);
      if (res.data != null) {
        int code = res.data['code'];
        if (20000 == code) {
          getFollowUserState();
  ...
  getUserPicture() async {
    try {
      var res =
          await G.req.shop.getUserPictureReq(tk: widget.tk, user_id: widget.id);
      if (res.data != null) {
        int code = res.data['code'];
        if (20000 == code) {
          setState(() {
  ...
  getUserVoice() async {
    try {
      var res =
          await G.req.shop.getUserVoiceReq(tk: widget.tk, user_id: widget.id);
      if (res.data != null) {
        int code = res.data['code'];
        if (20000 == code) {
          voiceList.clear();
  ...
  visitUserReq() async {
    try {
      ...
      var res = await G.req.shop.visitUserReq(
          tk: this.widget.tk, follow_id: widget.id, user_id: account_id);
